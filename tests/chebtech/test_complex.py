...
def complex_function():
    """Create a complex Chebtech2 function for testing.

    This fixture creates a Chebtech2 object representing the complex function
    exp(π·i·x), which is used in multiple tests for complex function operations.

    Returns:
        Chebtech2: A Chebtech2 object representing exp(π·i·x)
    """
